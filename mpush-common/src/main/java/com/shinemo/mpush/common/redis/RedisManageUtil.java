...
public class RedisManageUtil {
	...
	private static final RedisManage redisManage = ServiceContainer.getInstance(RedisManage.class);

	public static long incr(String key,Integer time){
		List<RedisNode> nodeList = redisManage.hashSet(key);
    ...
    public static <T> T get(String key, Class<T> clazz) {
        RedisNode node = redisManage.randomGetRedisNode(key);
    ...
    public static <T> T hget(String namespace, String key, Class<T> clazz) {
        ...
        RedisNode node = redisManage.randomGetRedisNode(namespace);
        return RedisUtil.hget(node, namespace, key, clazz);

    }

    public static void hdel(String namespace, String key) {
        List<RedisNode> nodeList = redisManage.hashSet(namespace);
    ...
    public static <T> void publish(String channel, T message) {
        ...
        RedisNode node = redisManage.randomGetRedisNode(channel);
    ...
    public static void subscribe(JedisPubSub pubsub, String... channels) {
        ...
        for (String channel : channels) {
            List<RedisNode> nodeList = redisManage.hashSet(channel);
            set.addAll(nodeList);
        }
