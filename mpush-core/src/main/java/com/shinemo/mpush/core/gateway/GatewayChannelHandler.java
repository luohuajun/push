...
public final class GatewayChannelHandler extends ChannelHandlerAdapter {

    private static final Logger LOGGER = LoggerFactory.getLogger(GatewayChannelHandler.class);

    private final ConnectionManager connectionManager;
    private final PacketReceiver receiver;

    public GatewayChannelHandler(ConnectionManager connectionManager, PacketReceiver receiver) {
