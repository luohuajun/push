...
public final class GatewayClientChannelHandler extends ChannelHandlerAdapter implements ChannelClientHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(GatewayClientChannelHandler.class);

    private Client client;

    public GatewayClientChannelHandler(Client client) {
        this.client = client;
    }
